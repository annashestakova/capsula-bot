...
async def main():
    ...
    async def cb_buy_guide(cb: CallbackQuery):
        ...
        await cb.message.edit_text(
            f"💎 <b>Гайд «Секреты долгой носки наращивания»</b>\\n\\n"
            "10 страниц. Только практика — без воды:\\n"
            "✅ Рекомендованные средства: HADAT, TIGI After Party, L'Oréal Absolut Repair — зачем каждое\\n"
            "✅ Укладка, сон, расчёсывание — всё по шагам\\n"
